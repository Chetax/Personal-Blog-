...
const Navbar=()=>{
   ...
   <Col className="col-2 d-flex  justify-content-end">   <FontAwesomeIcon style={{cursor:'pointer'}} icon={faBars} /> </Col>
   <Col className="col-4 d-flex  justify-content-center">Menu</Col>
   <Col onClick={()=>{dispnewblock(0)}} className="col-4 d-flex  justify-content-end"><FontAwesomeIcon style={{color:"#cccccc"}} icon={ faXmark}/></Col>
    </Container>
    </div>
   ...
   <Col className="col-2 d-flex  justify-content-end mb-5"><FontAwesomeIcon style={{color:"#cccccc"}} /></Col>
    ...
    <div id="seconddiv" className="container-fluid  "  >
    <div className="col-1 " onClick={()=>{dispnewblock(1)}}style={{backgroundColor:"yellow",height:"100vh", width:"55px"} }>
    <FontAwesomeIcon  style={{cursor:'pointer',display:'flex',justifyContent:"center"}} icon={faBars} /> 
    </div>
    </div>
    </>
}
